...
import io.github.loadup.gateway.facade.exception.RouteException;
...
public class ActionDispatcher {
  ...
  @Resource private RouteResolver routeResolver;
    ...
    try {
      ...
      if (!routeOpt.isPresent()) {
        ...
        return ExceptionHandler.handleException(
            request.getRequestId(), routeException, stopWatch.getTime());
      }
      ...
      return ExceptionHandler.handleException(request.getRequestId(), e, stopWatch.getTime());
    } catch (Exception e) {
      ...
      return ExceptionHandler.handleException(
          request.getRequestId(), wrappedException, stopWatch.getTime());
    }
  }
  ...
  private GatewayResponse buildErrorResponse(
      GatewayRequest request, Exception e, long processingTime) {
    return GatewayResponse.builder()
        .requestId(request.getRequestId())
